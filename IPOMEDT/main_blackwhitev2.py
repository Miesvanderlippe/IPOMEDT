    ...
    try:
        while True:
            ...
            if lightsensor is True and distance > 30:  # true als de onder sensor op zwarte opevlakte rijd en de boven sensor geen opstake heeft gevonden
                ...
                testmotor1.forward(45) #  Geef vollen gas naar voren met motor1
                testmotor2.forward(50) # Geef vollen gas naar voren met motor2
            ...
            elif lightsensor is True and distance < 30 and swich is True and teller < 5: #  Als hij op Zwart rijd
